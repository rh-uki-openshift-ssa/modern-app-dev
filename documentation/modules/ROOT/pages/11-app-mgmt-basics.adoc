...
----
Name:             mapit-6bf6697795-nrstx
Namespace:        app-management
Priority:         0
Service Account:  default
Node:             ip-10-0-33-207.us-east-2.compute.internal/10.0.33.207
Start Time:       Mon, 20 May 2024 12:15:16 +0000
Labels:           deployment=mapit
                  pod-template-hash=6bf6697795
Annotations:      k8s.ovn.org/pod-networks:
                    {"default":{"ip_addresses":["10.128.2.22/23"],"mac_address":"0a:58:0a:80:02:16","gateway_ips":
...
IPs:
  IP:           10.128.2.22
Controlled By:  ReplicaSet/mapit-6bf6697795
Containers:
  mapit:
    Container ID:   cri-o://f83cfad8886abfd322f21b4af6148109b711b4414c864f8d44308cc6b1f9c0bd
...
9efd1de9d
    ...
    State:          Running
      Started:      Mon, 20 May 2024 12:15:27 +0000
    Ready:          True
    Restart Count:  0
    Environment:    <none>
    Mounts:
      /var/run/secrets/kubernetes.io/serviceaccount from kube-api-access-jwx4v (ro)
Conditions:
  Type              Status
  Initialized       True
  Ready             True
...
Events:
  ...
  ----    ------          ----  ----               -------
  Normal  Scheduled       27s   default-scheduler  Successfully assigned app-management/mapit-6bf6697795-nrstx to
ip-10-0-33-207.us-east-2.compute.internal
  Normal  AddedInterface  27s   multus             Add eth0 [10.128.2.22/23] from ovn-kubernetes
  Normal  Pulling         27s   kubelet            Pulling image "quay.io/openshiftroadshow/mapit@sha256:1366b430c
7d4bddf35c7b2d067bc24e8d67ba297dbaacd10e0d80939efd1de9d"
  Normal  Pulled          17s   kubelet            Successfully pulled image "quay.io/openshiftroadshow/mapit@sha2
56:1366b430c7d4bddf35c7b2d067bc24e8d67ba297dbaacd10e0d80939efd1de9d" in 10.309987906s (10.310011366s including wai
ting)
  Normal  Created         17s   kubelet            Created container mapit
  Normal  Started         17s   kubelet            Started container mapit
----
...
TargetPort:        8778/TCP
Endpoints:         10.128.2.22:8778
Port:              9779-tcp  9779/TCP
TargetPort:        9779/TCP
Endpoints:         10.128.2.22:9779
...
metadata:
  annotations:
    openshift.io/generated-by: OpenShiftNewApp
  creationTimestamp: "2024-05-20T12:15:16Z"
  labels:
    app: mapit
    app.kubernetes.io/component: mapit
    app.kubernetes.io/instance: mapit
  ...
  uid: 7d4a9d5b-68c4-46b6-b7cd-1d3d928b6557
spec:
  clusterIP: 172.30.226.25
  clusterIPs:
  - 172.30.226.25
...
Port:              8080-tcp  8080/TCP
TargetPort:        8080/TCP
Endpoints:         10.128.2.22:8080,10.129.2.27:8080
Port:              8778-tcp  8778/TCP
TargetPort:        8778/TCP
Endpoints:         10.128.2.22:8778,10.129.2.27:8778
Port:              9779-tcp  9779/TCP
TargetPort:        9779/TCP
Endpoints:         10.128.2.22:9779,10.129.2.27:9779
Session Affinity:  None
Events:            <none>
----
